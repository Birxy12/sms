// 36 States in Nigeria + FCT with their respective Local Government Areas (LGAs)
...
export const NIGERIA_STATES = Object.keys(NIGERIA_STATES_AND_LGAS).sort((a, b) => a.localeCompare(b));

export const getLgasForState = (stateName) => {
  if (!stateName) return [];
  return NIGERIA_STATES_AND_LGAS[stateName] || [];
};
