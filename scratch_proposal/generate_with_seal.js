...
const sealImage = fs.readFileSync("C:\\Users\\globi\\sms\\src\\assets\\seal.png");
  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          text: "Anyaegbu Emmanuel - CEO GlobixTech",
          alignment: AlignmentType.CENTER,
          spacing: { before: 100 },
        }),
      ],
...
Packer.toBuffer(doc).then((buffer) => {
  fs.writeFileSync("C:\\Users\\globi\\Downloads\\School_Management_System_Proposal_With_Seal.docx", buffer);
  console.log("Document created successfully with seal at C:\\Users\\globi\\Downloads\\School_Management_System_Proposal_With_Seal.docx");
});
